...
public class ReacaoDTO {
	...
	private String id; // Atributo que recebe o identificador do relato instanciado.	
	private int confirmado; // Atributo que recebe o total de confirmações do relato instanciado.	
	private int denunciado; // Atributo que recebe o total de denúncias do relato instanciado.	
	private String mensagem; // Atributo que retorna mensagem de acordo com a operação realizada.
