...
public class UsuariosServices {
	...
	public List<Usuario> listar(){
		List<Usuario> usuarios = usuariosRepository.findAll(); // Lista de usuários recuperados do banco de dados.
		...
		for(Usuario u : usuarios) {
			// Decodifi-se o nº do celular e o reatribui ao atributo "celular" de cada usuário da lista.
			u.setCelular(decodificarCelular(u.getCelular())); 
			usuariosDecifrados.add(u); // Inclui cada usuário com celular decifrado na lista "usuariosDecifrados".
		}
	...
	public Usuario buscarPeloCelular(String celular) {	
		// O métedo "cifrarCelular()" é invocado recebendo o nº do celular. Somente a partir de então, o método 
		// "findByCelular()" pode fazer a busca pela cifra registrada no banco de dados. 
